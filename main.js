...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		*/
		...
		{
			return (Math.random()>0.05?(choose(['Par\'s','Pars'])+' '):'Mc')+choose(['Victim','victim']);
		}
		...
		Game.bakeryNameRefresh=function()
		{
			...
			if (name=='par') Game.Win('Par complex');
		...
		Game.UpdateMenu=function()
		{
			...
			if (Game.onMenu=='prefs')
			{
				...
				" '+Game.clickStr+'="Game.HardReset();PlaySound(\'snd/tick.mp3\');">Wipe save</a><label>Delete all your progress, including your achievements</label></div>'+
	...
	Game.Logic=function()
	{
		...
		if (!Game.OnAscend && Game.AscendTimer==0)
		{
			...
			if (Game.T%(Game.fps*5)==0 && Game.ObjectsById.length>0)//check some achievements and upgrades
			{
				...
				if (Game.cookieclicks>=69) {Game.Win('Nice');}
